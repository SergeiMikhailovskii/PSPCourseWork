...
public class LoginController extends BaseController<LoginWindow> {
    ...
    public void logInUser(String login, String password) {
        if (!login.isEmpty() && !password.isEmpty()) {
            ...
            if (role == -1) {
                ...
                view.showMessageDialog("Вы вошли как администратор", JOptionPane.INFORMATION_MESSAGE);
    ...
    public void registerUser(String login, String password) {
        ...
        if (result.equalsIgnoreCase(Callbacks.INSERTED)) {
            view.showMessageDialog("Регистрация прошла успешно!", JOptionPane.INFORMATION_MESSAGE);
